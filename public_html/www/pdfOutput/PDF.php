...
class PDFF extends FPDF
{
	...
	function HeaderInfosPerso($data){
		...
		$this->Ln();
		$this->SetTextColor(31,73,125);
		$this->Cell(190,6,'Etat de frais Engag�s','LRT',0,'C',0);
		$this->Ln();
    ...
    ************************************************************/
	...
	function Footer(){
		...
		$lines['indent'] = 0;
		$lines['spacer'] = 0;
		$lines['text'][0] = "(V�hicule  4CV Diesel) 	0.52 � / Km";
		$lines['text'][1] = "(V�hicule 5/6CV Diesel) 	0.58 � / Km";
		$lines['text'][2] = "(V�hicule  4CV Essence) 	0.62 � / Km";
		$lines['text'][3] = "(V�hicule 5/6CV Essence) 	0.67 � / Km";
		// Go to 1.5 cm from bottom
		$this->SetY(-50);
		// Select Arial italic 8
		$this->SetFont('times','I',10);
		// Print centered page number
		$this->Cell(0,4,'1 Les frais forfaitaires doivent �tre justifi�s par une facture acquitt�e faisant appara�tre le montant de la TVA.','T',0,false);
		$this->Ln();
		$this->Cell(0,4,'Ces documents ne sont pas � joindre � l��tat de frais mais doivent �tre conserv�s pendant trois ann�es. Ils',0,0,false);
		$this->Ln();
		$this->Cell(0,4,'peuvent �tre contr�l�s par le d�l�gu� r�gional ou le service comptable',0,0,false);
		$this->Ln();
		$this->Cell(0,4,"2 Tarifs en vigueur au 01/09/2017",0,0,'L',0);
		$this->Ln();
		$this->Cell(0,4,"3 Prix au kilom�tre en fonction du v�hicule d�clar� aupr�s des services comptables	",0,0,'L',0);
		$this->Ln();
		$this->MultiCellBltArray($column_width-$this->x,6,$lines);
		$this->Cell(0,4,"4 Tout frais � hors forfait � doit �tre d�ment justifi� par l�envoi d�une facture acquitt�e faisant appara�tre le montant de TVA",0,0,'L',0);
	}
}  
	...
	$header2 = array('Fraits forfaitaires', 'Quantite', 'Montant Unitaire', 'Total');
	// Data loading
